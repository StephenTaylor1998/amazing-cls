...
class SpikePreActResNetCifar(nn.Module):
    def __init__(self, block_type, layers, num_classes=10, in_channels=3, zero_init_residual=False,
        ...
        self.layer2 = self._make_layer(
            block, 64, layers[1], stride=2, dilate=replace_stride_with_dilation[0], neuron_cfg=neuron_cfg)
        self.layer3 = self._make_layer(
            block, 128, layers[2], stride=2, dilate=replace_stride_with_dilation[1], neuron_cfg=neuron_cfg)
        self.layer4 = self._make_layer(
            block, 256, layers[3], stride=2, dilate=replace_stride_with_dilation[2], neuron_cfg=neuron_cfg)
