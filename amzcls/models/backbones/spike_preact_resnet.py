...
__all__ = ['SpikePreActResNetCifar', 'spike_preact_resnet18_cifar', 'spike_preact_resnet34_cifar',
...
class SpikePreActResNetCifar(nn.Module):
    def __init__(self, block_type, layers: list, width: list=None, stride: list = None,  num_classes=10,
                 ...
                 replace_stride_with_dilation=None, norm_layer=None, neuron_cfg=None):
        super().__init__()
        ...
        self.layer1 = self._make_layer(
            block, width[0], layers[0], stride[0], neuron_cfg=neuron_cfg)
        self.layer2 = self._make_layer(
            block, width[1], layers[1], stride[1], dilate=replace_stride_with_dilation[0], neuron_cfg=neuron_cfg)
        self.layer3 = self._make_layer(
            block, width[2], layers[2], stride[2], dilate=replace_stride_with_dilation[1], neuron_cfg=neuron_cfg)
        self.layer4 = self._make_layer(
            block, width[3], layers[3], stride[3], dilate=replace_stride_with_dilation[2], neuron_cfg=neuron_cfg)
    ...
    def _make_layer(self, block, planes, blocks, stride=1, dilate=False, neuron_cfg=None):
        ...
        layers.append(block(
            ...
            previous_dilation, norm_layer, neuron_cfg))
...
def _resnet_cifar(arch, pretrained, progress, **kwargs):
    model = SpikePreActResNetCifar(**kwargs)
    if pretrained:
...
@BACKBONES.register_module()
def spike_preact_resnet_cifar(*args, **kwargs):
    return SpikePreActResNetCifar(*args, **kwargs)


@BACKBONES.register_module()
def spike_preact_resnet18_cifar(pretrained=False, progress=True, **kwargs):
    return _resnet_cifar('resnet18', pretrained, progress, layers=[2, 2, 2, 2], **kwargs)


@BACKBONES.register_module()
def spike_preact_resnet34_cifar(pretrained=False, progress=True, **kwargs):
    return _resnet_cifar('resnet34', pretrained, progress, layers=[3, 4, 6, 3], **kwargs)


@BACKBONES.register_module()
def spike_preact_resnet50_cifar(pretrained=False, progress=True, **kwargs):
    return _resnet_cifar('resnet50', pretrained, progress, layers=[3, 4, 6, 3], **kwargs)


@BACKBONES.register_module()
def spike_preact_resnet101_cifar(pretrained=False, progress=True, **kwargs):
    return _resnet_cifar('resnet101', pretrained, progress, layers=[3, 4, 23, 3], **kwargs)


@BACKBONES.register_module()
def spike_preact_resnet152_cifar(pretrained=False, progress=True, **kwargs):
    return _resnet_cifar('resnet152', pretrained, progress, layers=[3, 8, 36, 3], **kwargs)


@BACKBONES.register_module()
def spike_preact_resnext50_cifar_32x4d(pretrained=False, progress=True, **kwargs):
    kwargs['groups'] = 32
...
@BACKBONES.register_module()
def spike_preact_resnext101_cifar_32x8d(pretrained=False, progress=True, **kwargs):
    kwargs['groups'] = 32
...
@BACKBONES.register_module()
def spike_preact_wide_resnet50_cifar_2(pretrained=False, progress=True, **kwargs):
    kwargs['width_per_group'] = 64 * 2
    return _resnet_cifar('wide_resnet50_2', pretrained, progress, layers=[3, 4, 6, 3], **kwargs)


@BACKBONES.register_module()
def spike_preact_wide_resnet101_cifar_2(pretrained=False, progress=True, **kwargs):
    kwargs['width_per_group'] = 64 * 2
