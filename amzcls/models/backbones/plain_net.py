...
class PlainDigital(BasicBlock):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1, base_width=64,
                 dilation=1, norm_layer=None, rate=1., neuron_cfg=None):
...
# channel: 64->64->64
@MODELS.register_module()
def plain_digital_a(*args, **kwargs):
    return PlainDigital(rate=1., *args, **kwargs)


# channel: 128->32->128
@MODELS.register_module()
def plain_digital_b(*args, **kwargs):
    return PlainDigital(rate=0.25, *args, **kwargs)


# channel: 32->128->32
@MODELS.register_module()
def plain_digital_c(*args, **kwargs):
    return PlainDigital(rate=4., *args, **kwargs)


# channel: 64->64->64
@MODELS.register_module()
def plain_analog_a(*args, **kwargs):
    return PlainAnalog(rate=1., *args, **kwargs)


# channel: 128->32->128
@MODELS.register_module()
def plain_analog_b(*args, **kwargs):
    return PlainAnalog(rate=0.25, *args, **kwargs)


# channel: 32->128->32
@MODELS.register_module()
def plain_analog_c(*args, **kwargs):
    return PlainAnalog(rate=4., *args, **kwargs)
