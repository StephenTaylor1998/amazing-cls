...
from .spike_df_resnet import DFResNetCifar, df_resnet18c_cifar, df_resnet34c_cifar, df_resnet50c_cifar, \
    ...
    df_resnet101b_cifar, df_resnet152b_cifar, df_resnext50b_cifar_32x4d, df_resnext101b_cifar_32x8d, \
    df_wide_resnet50b_cifar_2, df_wide_resnet101b_cifar_2, df_resnet18a_cifar, df_resnet34a_cifar, df_resnet50a_cifar, \
    df_resnet101a_cifar, df_resnet152a_cifar, df_resnext50a_cifar_32x4d, df_resnext101a_cifar_32x8d, \
    df_wide_resnet50a_cifar_2, df_wide_resnet101a_cifar_2
