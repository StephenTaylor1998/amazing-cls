...
if USE_MMCLS:
    DATASETS = MMCLS_DATASETS
    PIPELINES = MMCLS_PIPELINES
    SAMPLERS = MMCLS_SAMPLERS
else:
    DATASETS = Registry('dataset', parent=MMCLS_DATASETS)
    PIPELINES = Registry('pipeline', parent=MMCLS_PIPELINES)
    SAMPLERS = Registry('sampler', parent=MMCLS_SAMPLERS)


def build_dataset(cfg, default_args=None):
    from mmcls.datasets.dataset_wrappers import (ClassBalancedDataset, ConcatDataset,
